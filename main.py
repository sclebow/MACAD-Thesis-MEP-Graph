...
app = pn.Column(
    pn.Row(
        pn.Column(
            pn.Row(
                pn.Spacer(width=0),  # Adjust this value to move the logo horizontally
                pn.pane.PNG('assetpulse_logo.png', width=120, height=120, sizing_mode='fixed'),
                sizing_mode='fixed',
                width=220,
                height=80,
            ),
            pn.Row(
                pn.Spacer(width=10),
                pn.pane.Markdown("<span style='font-size:10px;font-weight:400;line-height:1.2;'>From Data to Foresight</span>", sizing_mode='fixed', width=120, height=80),
                sizing_mode='fixed',
                width=180,
                height=40,
            ),
